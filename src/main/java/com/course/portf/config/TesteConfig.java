...
import com.course.portf.repositories.CategoryRepository;
import com.course.portf.repositories.OrderItemRepository;
...
public class TesteConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		User u1 = new User(  "erick.szns@hotmail.com","Érick de Souza Nunes", "47997187766", "15084");
		User u2 = new User(  "nataly.araujo@gmail.com","Nataly Araujo", "4799782147", "123456");
